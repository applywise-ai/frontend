  ...
  return (
    <div className="bg-gray-900 text-white">
      <section className="flex min-h-screen flex-col items-center justify-center p-8 md:p-24">
        <h1 className="text-xl sm:text-3xl md:text-4xl text-center font-bold text-white mb-6">
          Welcome to ApplyWise
        </h1>
        <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl text-center mb-8">
      ...
      <section className="min-h-screen bg-gray-800 p-8 md:p-24 flex flex-col items-center justify-center">
        <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-white mb-8">Features</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl">
          <div className="bg-gray-900 p-6 rounded-lg">
            <h3 className="text-base sm:text-xl font-semibold mb-4">Track Applications</h3>
            <p>Keep all your job applications organized in one place with status updates and deadlines.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg">
            <h3 className="text-base sm:text-xl font-semibold mb-4">Resume Management</h3>
            <p>Store different versions of your resume and match them to the right opportunities.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg">
            <h3 className="text-base sm:text-xl font-semibold mb-4">Interview Preparation</h3>
