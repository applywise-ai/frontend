            ...
            {isLoggedIn && (
              <div className="hidden md:flex items-center ml-4 space-x-2 lg:space-x-6">
                ...
                <Link 
                  href="/applications" 
                  className={`flex items-center py-2 px-3 rounded-md transition-colors ${
                    pathname === '/applications' || pathname?.startsWith('/applications/') ? 'text-teal-700 font-semibold' : 'text-gray-700 hover:text-teal-600 font-medium'
                  }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2">
            ...
            <div ref={mobileMenuRef} className="absolute top-16 left-0 w-full bg-white shadow-md z-40 border-t border-gray-200">
              <div className="px-4 py-2">
                ...
                <Link 
                  href="/applications" 
                  className={`flex items-center py-3 ${
                    pathname === '/applications' || pathname?.startsWith('/applications/') ? 'text-teal-700 font-semibold' : 'text-gray-700'
                  }`}
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-3">
